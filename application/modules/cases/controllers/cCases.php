...
class cCases extends MY_Main {
  ...
  /* -----------------------------------------------
   * @ METODO CADASTRAR MINIATURA
   * ----------------------------------------------- */
  public function cadastrarMiniatura($idEntry) {
    // # scripts e estilos
    /* JGROWL */
    $this->addStyle('statics/admin/css/plugins/jquery.jgrowl.css');
    $this->addScript('statics/admin/js/plugins/jGrowl/jquery.jgrowl.js');
    ...
    $this->data['cas_foto']   = $this->m_crud->get_rowSpecific('tb_cases', 'cas_id', $idEntry, 1, 'cas_foto');
    $this->data['cas_id']     = $idEntry;
    $this->data['voltar']     = 'cases/cCases/cadastrar';
    $this->loadtemplate('vCadastrarMiniatura');
  }
  ...
  public function gravar() {
    ...
    $settings = array(
      ...
      'retorno_funcao'  => 'cases/cCases/cadastrar/',
      /* TITLES */
      'titleSection'    => '',
      'subtitleSection' => '',
      );
   ...
   * @ GRAVAR MINIATURA
   * ----------------------------------------------- */
  public function gravarMiniatura($idEntry) {
    $validation = array(
      array('cas_titulo', 'TÍTULO', 'required'),
    );
    ...
    $settings = array(
      ...
      /* TABELA E OPERACOES */
      'tabela'          => 'tb_cases',
      'retorno_arquivo' => 'vCadastrarMiniatura',
      'retorno_funcao'  => 'cases/cCases/cadastrarMiniatura/' . $idEntry,
