...
class M_pessoa extends CI_Model {
    ...
    function listarTodosEstadoCivil() {
        return $this->db->get('tb_estadocivil')->result();
    }

    function listarTodosFormacaoEscolar() {
        return $this->db->get('tb_formacaoescolar')->result();
    }
